...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Interactive Quizzes - Test Your Knowledge | Noterious",
    description:
      "Challenge yourself with interactive quizzes designed to test your understanding and reinforce learning.",
    url: `${process.env.NEXT_PUBLIC_WEBSITE_URL || "http://stag.Noterious.in"}/quiz`,
    siteName: "Noterious",
    locale: "en_US",
    type: "website",
  },
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_WEBSITE_URL || "http://stag.Noterious.in"}/quiz`,
  },
  robots: {
    index: true,
    follow: true,
