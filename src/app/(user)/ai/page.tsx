...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Study Assistant - Personalized Learning Support | Noterious",
    description:
    ...
    url: `${process.env.NEXT_PUBLIC_WEBSITE_URL || "http://stag.Noterious.in"}/ai`,
    siteName: "Noterious",
    locale: "en_US",
    type: "website",
  },
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_WEBSITE_URL || "http://stag.Noterious.in"}/ai`,
  },
  robots: {
    index: true,
    follow: true,
