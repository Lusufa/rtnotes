...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Study Notes - Comprehensive Academic Resources | Noterious",
    description:
    ...
    url: `${process.env.NEXT_PUBLIC_WEBSITE_URL || "http://stag.Noterious.in"}/notes`,
    siteName: "Noterious",
    locale: "en_US",
    type: "website",
  },
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_WEBSITE_URL || "http://stag.Noterious.in"}/notes`,
  },
  robots: {
    index: true,
    follow: true,
