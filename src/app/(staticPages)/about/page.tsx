...
export const metadata: Metadata = {
  title: "About | Noterious",
  description:
    "Learn more about Noterious, our mission, and how we help students learn smarter.",
};
